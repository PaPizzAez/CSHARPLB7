...
namespace LB7
{
    ...
    {
        private static string connecting = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Cringe;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
